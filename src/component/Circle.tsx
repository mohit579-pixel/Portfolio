...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[500px] w-[100%] items-center justify-center overflow-hidden rounded-lg  bg-background p-10 md:shadow-xl"
      ref={containerRef}
    >
...
const Icons = {
  ...
  openai: () => (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="https://res.cloudinary.com/dymfsdc1w/image/upload/v1723787950/Foody/dhnjpcfdclfewpm9nzor.png" />
    </svg>
  ),
  googleDrive: () => (
    <svg
